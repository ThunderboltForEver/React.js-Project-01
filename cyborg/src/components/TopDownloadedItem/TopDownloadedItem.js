            ...
            <div className='your-gaming-item'>
                <div className='game-name'>
                    ...
                    <ul>
                        ...
                        <li><FaStar style={{ color: 'yellow', marginRight: '4px' }} /><span style={{ marginRight: '8px' }}>{props.rates}</span><FaDownload style={{ color: '#ec6090', marginRight: '4px' }} /><span>{props.downloads}</span></li>
                    </ul>
                </div>
            </div>
            <hr />
